...
public class CommonUtils {
	...
	private static String REGEX_MOBILE = "^[1](([3|5|8][\\d])|([4][5,6,7,8,9])|([6][5,6])|([7][3,4,5,6,7,8])|([9][8,9]))[\\d]{8}$";// 验证手机号
	...
	/**
	 * 这个方法可以通过与某个类的class文件的相对路径来获取文件或目录的绝对路径。 通常在程序中很难定位某个相对路径，特别是在B/S应用中。 通过这个方法，我们可以根据我们程序自身的类文件的位置来定位某个相对路径。 比如：某个txt文件相对于程序的Test类文件的路径是../../resource/test.txt， 那么使用本方法Path.getFullPathRelateClass("../../resource/test.txt",Test.class) 得到的结果是txt文件的在系统中的绝对路径。
	 * 
	...
	public static void main(String args[]) {
		System.out.println(sntoConceal("201958171758463689632843453522"));
	}
	...
	public static String sntoConceal(String value) {
		if (null == value || "".equals(value)) {
			return value;
		}
		return value.replaceAll("(\\d{8})\\d+(\\d{6})","$1****$2");
	}
	 ...
	 * @return
	 */
	public static BigDecimal roundHalfUp(BigDecimal amount) {
