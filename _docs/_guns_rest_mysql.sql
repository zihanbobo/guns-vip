...
CREATE TABLE `database_info`  (
  ...
  `remarks` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '备注，摘要',
...
-- ----------------------------
INSERT INTO `database_info` VALUES (1181910831377588226, 'master', 'com.mysql.cj.jdbc.Driver', 'root', 'root', 'jdbc:mysql://127.0.0.1:3306/guns?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2019-10-09 20:34:35');
...
CREATE TABLE `oa_myleave`  (
  ...
  `STARTTIME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '开始时间',
  `ENDTIME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '结束时间',
  `WHENLONG` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '时长',
  `REASON` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '事由',
...
CREATE TABLE `sys_dept`  (
  ...
  `pids` varchar(512) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '父级ids',
...
CREATE TABLE `sys_dict`  (
  ...
  `parent_ids` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '所有上级id',
  `status` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'ENABLE' COMMENT '状态（字典）',
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  `description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字典的描述',
  `create_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT NULL COMMENT '更新时间',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建人',
  `update_user` bigint(20) DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `sys_dict_type`  (
  ...
  `description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '字典描述',
...
CREATE TABLE `sys_file_info`  (
  ...
  `file_bucket` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文件仓库（oss仓库）',
  ...
  `file_path` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '存储路径',
  `create_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建用户',
...
-- ----------------------------
INSERT INTO `sys_login_log` VALUES (1181910611650551809, '登录日志', 1, '2019-10-09 20:33:43', '成功', NULL, '127.0.0.1');
INSERT INTO `sys_login_log` VALUES (1181910871433191426, '登录日志', 1, '2019-10-09 20:34:45', '成功', NULL, '127.0.0.1');
INSERT INTO `sys_login_log` VALUES (1181911161716776961, '登录日志', 1, '2019-10-09 20:35:54', '成功', NULL, '127.0.0.1');
INSERT INTO `sys_login_log` VALUES (1181911228527845377, '登录日志', 1, '2019-10-09 20:36:10', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1181911546368008194, '退出日志', 1, '2019-10-09 20:37:26', '成功', NULL, '0:0:0:0:0:0:0:1');
INSERT INTO `sys_login_log` VALUES (1181911580539002882, '登录日志', 1, '2019-10-09 20:37:34', '成功', NULL, '127.0.0.1');
INSERT INTO `sys_login_log` VALUES (1181911623811637249, '登录日志', 1, '2019-10-09 20:37:45', '成功', NULL, '0:0:0:0:0:0:0:1');
...
CREATE TABLE `sys_menu`  (
  ...
  `system_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '系统分类(字典)',
  `create_time` datetime(0) DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) DEFAULT NULL COMMENT '修改时间',
  `create_user` bigint(20) DEFAULT NULL COMMENT '创建人',
  `update_user` bigint(20) DEFAULT NULL COMMENT '修改人',
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (105, 'system', '0', '[0],', '系统管理', 'layui-icon layui-icon-set', '/admin', 20, 1, 'Y', NULL, 'ENABLE', NULL, '1', 'BASE_SYSTEM', NULL, '2019-03-29 16:32:27', NULL, 1);
...
-- ----------------------------
INSERT INTO `sys_operation_log` VALUES (1181911142028713986, '业务日志', '配置权限', 1, 'cn.stylefeng.guns.sys.modular.rest.controller.RestRoleController', 'setAuthority', '2019-10-09 20:35:50', '成功', '角色名称=超级管理员,资源名称=用户管理,添加用户,修改用户,删除用户,重置密码,冻结用户,解除冻结用户,分配角色,分配角色跳转,编辑用户跳转,用户列表,角色管理,添加角色,修改角色,删除角色,配置权限,修改角色跳转,角色分配跳转,角色列表,菜单管理,添加菜单,修改菜单,删除菜单,菜单编辑跳转,菜单列表,业务日志,清空日志,日志列表,日志详情,部门管理,添加部门,修改部门,删除部门,修改部门跳转,部门列表,部门详情,字典管理,添加字典,修改字典,删除字典,修改菜单跳转,字典列表,字典详情,登录日志,清空登录日志,登录日志列表,通知管理,添加通知,修改通知,删除通知,职位管理,职位表添加,职位表修改,职位表删除,在线办公,工作流程,模型管理,流程管理,运行中流程,历史流程,任务管理,待办任务,已办任务,申请审批,请假审批');
INSERT INTO `sys_operation_log` VALUES (1181911459046793218, '业务日志', '配置权限', 1, 'cn.stylefeng.guns.sys.modular.system.controller.RoleController', 'setAuthority', '2019-10-09 20:37:05', '成功', '角色名称=超级管理员,资源名称=系统管理,用户管理,添加用户,修改用户,删除用户,重置密码,冻结用户,解除冻结用户,分配角色,分配角色跳转,编辑用户跳转,用户列表,角色管理,添加角色,修改角色,删除角色,配置权限,修改角色跳转,角色分配跳转,角色列表,菜单管理,添加菜单,修改菜单,删除菜单,菜单编辑跳转,菜单列表,业务日志,清空日志,日志列表,日志详情,部门管理,添加部门,修改部门,删除部门,修改部门跳转,部门列表,部门详情,字典管理,添加字典,修改字典,删除字典,修改菜单跳转,字典列表,字典详情,登录日志,清空登录日志,登录日志列表,通知管理,添加通知,修改通知,删除通知,职位管理,职位表添加,职位表修改,职位表删除');
INSERT INTO `sys_operation_log` VALUES (1181911697056768002, '业务日志', '配置权限', 1, 'cn.stylefeng.guns.sys.modular.system.controller.RoleController', 'setAuthority', '2019-10-09 20:38:02', '成功', '角色名称=超级管理员,资源名称=系统管理,用户管理,添加用户,修改用户,删除用户,重置密码,冻结用户,解除冻结用户,分配角色,分配角色跳转,编辑用户跳转,用户列表,角色管理,添加角色,修改角色,删除角色,配置权限,修改角色跳转,角色分配跳转,角色列表,菜单管理,添加菜单,修改菜单,删除菜单,菜单编辑跳转,菜单列表,业务日志,清空日志,日志列表,日志详情,部门管理,添加部门,修改部门,删除部门,修改部门跳转,部门列表,部门详情,字典管理,添加字典,修改字典,删除字典,修改菜单跳转,字典列表,字典详情,登录日志,清空登录日志,登录日志列表,通知管理,添加通知,修改通知,删除通知');
...
INSERT INTO `sys_relation` VALUES (1181911696314376193, 105, 1);
INSERT INTO `sys_relation` VALUES (1181911696318570497, 106, 1);
INSERT INTO `sys_relation` VALUES (1181911696326959106, 107, 1);
INSERT INTO `sys_relation` VALUES (1181911696331153409, 108, 1);
INSERT INTO `sys_relation` VALUES (1181911696339542018, 109, 1);
INSERT INTO `sys_relation` VALUES (1181911696347930626, 110, 1);
INSERT INTO `sys_relation` VALUES (1181911696352124929, 111, 1);
INSERT INTO `sys_relation` VALUES (1181911696360513538, 112, 1);
INSERT INTO `sys_relation` VALUES (1181911696364707842, 113, 1);
INSERT INTO `sys_relation` VALUES (1181911696368902145, 165, 1);
INSERT INTO `sys_relation` VALUES (1181911696373096449, 166, 1);
INSERT INTO `sys_relation` VALUES (1181911696381485058, 167, 1);
INSERT INTO `sys_relation` VALUES (1181911696385679362, 114, 1);
INSERT INTO `sys_relation` VALUES (1181911696389873665, 115, 1);
INSERT INTO `sys_relation` VALUES (1181911696398262274, 116, 1);
INSERT INTO `sys_relation` VALUES (1181911696406650881, 117, 1);
INSERT INTO `sys_relation` VALUES (1181911696410845186, 118, 1);
INSERT INTO `sys_relation` VALUES (1181911696415039489, 162, 1);
INSERT INTO `sys_relation` VALUES (1181911696419233793, 163, 1);
INSERT INTO `sys_relation` VALUES (1181911696427622402, 164, 1);
INSERT INTO `sys_relation` VALUES (1181911696431816706, 119, 1);
INSERT INTO `sys_relation` VALUES (1181911696436011010, 120, 1);
INSERT INTO `sys_relation` VALUES (1181911696440205314, 121, 1);
INSERT INTO `sys_relation` VALUES (1181911696448593922, 122, 1);
INSERT INTO `sys_relation` VALUES (1181911696452788226, 150, 1);
INSERT INTO `sys_relation` VALUES (1181911696452788227, 151, 1);
INSERT INTO `sys_relation` VALUES (1181911696461176834, 128, 1);
INSERT INTO `sys_relation` VALUES (1181911696465371138, 134, 1);
INSERT INTO `sys_relation` VALUES (1181911696473759745, 158, 1);
INSERT INTO `sys_relation` VALUES (1181911696477954050, 159, 1);
INSERT INTO `sys_relation` VALUES (1181911696486342658, 131, 1);
INSERT INTO `sys_relation` VALUES (1181911696490536962, 135, 1);
INSERT INTO `sys_relation` VALUES (1181911696494731265, 136, 1);
INSERT INTO `sys_relation` VALUES (1181911696503119874, 137, 1);
INSERT INTO `sys_relation` VALUES (1181911696503119875, 152, 1);
INSERT INTO `sys_relation` VALUES (1181911696511508481, 153, 1);
INSERT INTO `sys_relation` VALUES (1181911696519897090, 154, 1);
INSERT INTO `sys_relation` VALUES (1181911696519897091, 132, 1);
INSERT INTO `sys_relation` VALUES (1181911696528285698, 138, 1);
INSERT INTO `sys_relation` VALUES (1181911696532480001, 139, 1);
INSERT INTO `sys_relation` VALUES (1181911696545062913, 140, 1);
INSERT INTO `sys_relation` VALUES (1181911696549257217, 155, 1);
INSERT INTO `sys_relation` VALUES (1181911696553451521, 156, 1);
INSERT INTO `sys_relation` VALUES (1181911696557645826, 157, 1);
INSERT INTO `sys_relation` VALUES (1181911696561840130, 133, 1);
INSERT INTO `sys_relation` VALUES (1181911696566034434, 160, 1);
INSERT INTO `sys_relation` VALUES (1181911696574423042, 161, 1);
INSERT INTO `sys_relation` VALUES (1181911696578617346, 141, 1);
INSERT INTO `sys_relation` VALUES (1181911696578617347, 142, 1);
INSERT INTO `sys_relation` VALUES (1181911696587005953, 143, 1);
INSERT INTO `sys_relation` VALUES (1181911696591200258, 144, 1);
